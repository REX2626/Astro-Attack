...
class Drone_Enemy(Enemy_Ship):
    def __init__(self, position: Vector, velocity: Vector, max_speed=250, rotation=0, weapon=EnemyGatlingGun, health=1, shield=0, shield_delay=1, shield_recharge=1, state=0, mother_ship=None, image=images.WEAPON_ICON) -> None:
        super().__init__(position, velocity, max_speed, rotation, weapon, health, shield, shield_delay, shield_recharge, state, mother_ship, image)



class Mother_Ship(Enemy_Ship):
    def __init__(self, position: Vector, velocity: Vector, max_speed=100, rotation=0, weapon=EnemySniper, health=10, shield=3, shield_delay=5, shield_recharge=1, state=0, enemy_list=None, image=images.MOTHER_SHIP) -> None:
